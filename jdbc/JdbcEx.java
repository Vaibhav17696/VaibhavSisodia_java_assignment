...
public class JdbcEx {
    ...
    public static void main(String[] args) {
        ...
        try(Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/vaibhavdb","root","Vaibhav@1234567");)
        {
            
            
            //step 3: get statement object from Connection
              Statement st = con.createStatement();
              String s="INSERT INTO student1 VALUES(103888,'VAIBHAV','SISODIA')";
              st.execute(s);
